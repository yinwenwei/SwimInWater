        ...
        <div class="contant">
            ...
            <div class="xinxi clearfix">
                <div class="left">
                    ...
                    <ul>
                    <c:forEach items="${pageBean.list }" var="abroadList">
                        <li>
                            <div class="img"><img src="${pageContext.request.contextPath}/statics/images/04-search_03.jpg" alt=""></div>
                            <div class="text1">
                                <p>${abroadList.sName }</p>
                                <br/>
                                <p>[${abroadList.sCity }]${abroadList.sContent }</p>
                            </div>
                            <div class="price">
                                <p class="price_num">
                                    <span>&yen;</span>
                                    <span>${abroadList.sPrice }</span>
                                    <span>起</span>
                                </p>
                    ...
                    <div class="pageNum">
                        <ul>
                            <li><a href="Outbound_travel.action?currentPage=1">首页</a></li>
                            <li class="threeword"><a href="Outbound_travel.action?currentPage=${pageBean.prev }">上一页</a></li>
                            <li class="threeword"><a href="Outbound_travel.action?currentPage=${pageBean.next }">下一页</a></li>
                            <li class="threeword"><a href="Outbound_travel.action?currentPage=${pageBean.pageCount }">末页</a></li>
                        </ul>
                    </div>
                </div>
                <div class="right">
