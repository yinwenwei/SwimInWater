    ...
    <section id="login_wrap">
        ...
        <div class="login-box">
        	...
        	<div class="login_inner">
				...
				<form id="loginForm" action="${pageContext.request.contextPath }/dologin.action" method="post" accept-charset="utf-8">
        			<input type="hidden" name="action" value="login"/>
					<input name="uName" type="text" placeholder="请输入账号" autocomplete="off">
        			<input name="uPwd" type="password" placeholder="请输入密码" autocomplete="off">
