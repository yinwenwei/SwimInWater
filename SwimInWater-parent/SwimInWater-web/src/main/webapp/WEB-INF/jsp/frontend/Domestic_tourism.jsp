        ...
        <div class="contant">
            ...
            <div class="xinxi clearfix">
                <div class="left">
                    ...
                    <ul>
                    <c:forEach items="${pageBean.list }" var="chainList">
                        <li>
                    ...
                    <div class="pageNum">
                        <ul>
                            <li><a href="Domestic_tourism.action?currentPage=1">首页</a></li>
                            <li class="threeword"><a href="Domestic_tourism.action?currentPage=${pageBean.prev }">上一页</a></li>
                            <li class="threeword"><a href="Domestic_tourism.action?currentPage=${pageBean.next }">下一页</a></li>
                            <li class="threeword"><a href="Domestic_tourism.action?currentPage=${pageBean.pageCount }">末页</a></li>
                        </ul>
                    </div>
                </div>
                <div class="right">
