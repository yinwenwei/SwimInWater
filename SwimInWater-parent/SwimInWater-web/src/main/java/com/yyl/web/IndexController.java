...
public class IndexController {
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name="param1",value="参数1",required=true, paramType="query"),
		@ApiImplicitParam(name="param2",value="参数2",required=true, paramType="query"),
		@ApiImplicitParam(name="param3",value="参数3",required=true, paramType="query"),
		@ApiImplicitParam(name="param4",value="参数4",required=true, paramType="query")
	})
